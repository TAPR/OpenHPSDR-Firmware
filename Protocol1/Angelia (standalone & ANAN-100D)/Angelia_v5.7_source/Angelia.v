...
parameter  Angelia_version = 8'd57;		// Serial number of this version
...
assign FPGA_PTT = IO4 && (IF_Rx_ctrl_0[0] || CW_PTT); // IF_Rx_ctrl_0 only updated when we get correct sync sequence. CW_PTT is used when internal CW is selected
